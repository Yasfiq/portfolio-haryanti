...
const Footer = () => {
    ...
    return (
        <footer className="relative bg-gradient-to-b from-background to-tertiary/30 pb-28 md:pb-8">
            {/* Top gradient border */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-8 mb-10">
                    ...
                    <div className="text-center md:text-left">
                        <Link to="/" className="inline-block group">
                            ...
                            <p className="text-sm text-primary">Graphic Designer & Content Creator</p>
                        </Link>
                        <p className="mt-4 text-sm text-muted leading-relaxed max-w-xs mx-auto md:mx-0">
                            Creating visual stories that captivate and inspire. Let's bring your vision to life.
                        </p>
                    </div>
                ...
                <div className="pt-6 border-t border-secondary/10">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-3">
                        <p className="text-xs text-muted">
                            © {currentYear} Haryanti. All rights reserved.
                        </p>
