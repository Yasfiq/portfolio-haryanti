...
const Header = () => {
    ...
    return (
        <header
            className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 p-4 md:p-6 ${isVisible ? 'translate-y-0' : '-translate-y-full'
                }`}
        >
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        to="/contact"
                        className="hidden md:inline-flex px-5 py-2 bg-primary text-white text-sm font-medium rounded-full hover:bg-primary/90 transition-colors shadow-lg shadow-primary/30"
                    >
                        Let's Talk
                    </Link>
                </div>
